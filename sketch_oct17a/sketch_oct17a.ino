...
#define wifi_ssid "FiOS-YD7C2" //type your WIFI information inside the quotes
#define wifi_password "979mound2940slack"
...
#define OTApassword "piroko" // change this to whatever password you want to use when you upload OTA
int OTAport = 8266;
